...
function product_form($atts) {
    ...
    $html .= '<img src="/wp-content/uploads/2018/10/thumb_signature.jpg" />';
    $html .= '<div class="overlay"><span></span></div>';
    $html .= '<div class="bg-color-txt-pic">
                <img src="/wp-content/uploads/2018/10/icon_section_signature.png">
                <p>Signature Range</p>
              </div>';
    $html .= '</a>';
    $html .= '</div>';
    ...
    $html .= '<img src="/wp-content/uploads/2018/10/thumb_lavender.jpg" />';
    $html .= '<div class="overlay"><span></span></div>';
    $html .= '<div class="bg-color-txt-pic">
                <img src="/wp-content/uploads/2018/10/icon_section_lavender.png">
                <p>Lavander</p>
              </div>';
    $html .= '</a>';
    $html .= '</div>';
    ...
    $html .= '<img src="/wp-content/uploads/2018/10/thumb_aromatherapy.jpg" />';
    $html .= '<div class="overlay"><span></span></div>';
    $html .= '<div class="bg-color-txt-pic">
                <img src="/wp-content/uploads/2018/10/icon_section_aroma.png">
                <p>Aromatherapy</p>
              </div>';
    $html .= '</a>';
    $html .= '</div>';
    ...
    $html .= '<img src="/wp-content/uploads/2018/10/thumb_men.jpg" />';
    $html .= "<div class='overlay'><span></span></div>";
    $html .= "<div class='bg-color-txt-pic'>
                <img src='/wp-content/uploads/2018/10/icon_section_men.png'>
                <p>Men's Range</p>
              </div>";
    $html .= '</a>';
    $html .= '</div>';
    ...
    $html .= '<img src="/wp-content/uploads/2018/10/thumb_teen_boys.jpg" />';
    $html .= '<div class="overlay"><span></span></div>';
    $html .= '<div class="bg-color-txt-pic">
                <img src="/wp-content/uploads/2018/10/icon_section_teenboys.png">
                <p>Teen Boys</p>
              </div>';
    $html .= '</a>';
    $html .= '</div>';
    ...
    $html .= '<img src="/wp-content/uploads/2018/10/thumb_teen_girls.jpg" />';
    $html .= '<div class="overlay"><span></span></div>';
    $html .= '<div class="bg-color-txt-pic">
                <img src="/wp-content/uploads/2018/10/icon_section_teengirls.png">
                <p>Teen Girls</p>
              </div>';
    $html .= '</a>';
    $html .= '</div>';
    ...
    $html .= '<img src="/wp-content/uploads/2018/10/thumb_kids.jpg" />';
    $html .= '<div class="overlay"><span></span></div>';
    $html .= '<div class="bg-color-txt-pic">
                <img src="/wp-content/uploads/2018/10/icon_section_kids.png">
                <p>Kids</p>
              </div>';
    $html .= '</a>';
    $html .= '</div>';
    ...
    $html .= '<img src="/wp-content/uploads/2018/10/thumb_baby.jpg" />';
    $html .= '<div class="overlay"><span></span></div>';
    $html .= '<div class="bg-color-txt-pic">
                <img src="/wp-content/uploads/2018/10/icon_section_baby.png">
                <p>Baby</p>
              </div>';
    $html .= '</a>';
    $html .= '</div>';
